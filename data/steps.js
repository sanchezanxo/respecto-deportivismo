window.DEPOR_DATA = {
  ...
  config: {
    name: "Respecto para o Deportivismo",
    tagline: "Maratón Solución!",
    intro: "O Deportivo regresou a Primeira acompañado por unha afección que nunca o abandonou. Esta é a cronoloxía de como, en poucas semanas, unha sucesión de decisións rompeu esa comuñón.",
    ...
    outro_body: "Os seareiros non pedimos privilexios. Pedimos respecto, diálogo e unha solución ao conflito. O Deportivo chegou ata aquí coa súa xente. Sigamos xuntos!!",
    outro_cta: "Comparte",
  },
  ...
  steps: [
...

    {
      ...
      year: "2026",
      side: "dignidade",
      kicker: "Primeira mobilización",
      title: "O conflito chega á sede de ABANCA",
      body: "Unha manifestación percorre A Coruña desde a Praza de Pontevedra ata a sede de ABANCA. A protesta xa non se dirixe só contra as condicións de Maratón: comeza a cuestionarse abertamente a política da propiedade e da dirección do club.",
...

    {
      ...
      year: "2026",
      side: "infamia",
      kicker: "Genoa - Deportivo",
      title: "Un comunicado polémico en pleno conflito",
      body: "Na véspera do amigable contra o Genoa, ultras locais emboscan afeccionados deportivistas no centro da cidade, segundo a prensa italiana e a investigación policial. Poucas horas despois, o club marca distancias cos seus propios seguidores e abre a porta a sancións, reforzando a sensación de criminalización.",
      image: "",
      source: {
        label: "Comunicado do RC Deportivo",
...

    {
      ...
      year: "2026",
      side: "dignidade",
      kicker: "Teresa Herrera, de volta en Riazor",
      title: "Maratón queda baleira e a crise xa non se pode ocultar",
      body: "Federación de Peñas, Old Faces e Riazor Blues piden aos socios de Maratón Inferior que non entren contra o Real Madrid nin liberen a súa localidade. A bancada aparece practicamente baleira e desaparece a animación habitual. O club anuncia unha asistencia de 28.789 persoas.",
